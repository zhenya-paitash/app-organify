...
export class Seeder {
  ...
  async initDatabase(): Promise<void> {
    ...
    // Create database
    this.resourceIds.databaseId = await this.appwrite.createDatabase('OrganifyDB');
    ...
    // Create image bucket
    this.resourceIds.imagesBucketId = await this.appwrite.createBucket('OrganifyImages');
  }
